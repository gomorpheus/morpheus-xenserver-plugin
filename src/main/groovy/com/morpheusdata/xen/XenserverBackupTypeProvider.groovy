 ...
 */
@Slf4j
class XenserverBackupTypeProvider extends AbstractBackupTypeProvider {

	BackupExecutionProvider executionProvider;
	BackupRestoreProvider restoreProvider;

	XenserverBackupTypeProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getName() {
		return "Morpheus XenServer PluginBackupTypeProvider"
	}
