...
@Slf4j
class XenserverBackupProvider extends AbstractBackupProvider {
	...
	XenserverBackupProvider(Plugin plugin, MorpheusContext morpheusContext) {
		...
		XenserverBackupTypeProvider backupTypeProvider = new XenserverBackupTypeProvider(plugin, morpheus)
